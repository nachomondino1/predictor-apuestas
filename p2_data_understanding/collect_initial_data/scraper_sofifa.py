...
def extract_jugadores_sofifa(pais, liga, export=True):
    """
    ...
    select_liga_as_filter(crawler, pais, liga)  # El codigo funciona pero a veces falla en hacer click en la liga que quiero elegir.
