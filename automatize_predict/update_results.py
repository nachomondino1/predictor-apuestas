...
if __name__ == "__main__":
    ...
    # Levanto datasets
    df_historial_predicciones = pd.read_excel('p6_deployment/data/historial_predicciones.xlsx', index_col=0)  # Para garantizar que tengo todas las predicciones
    ...
    # Exportar dataset
    df.to_excel('p6_deployment/data/predicciones.xlsx')