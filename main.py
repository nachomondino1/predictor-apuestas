...
class DataPreparation:
    ...
    def nan_values_treatment(self, df , fill_na, percentil_nan: int = 75, export: bool = True):
        ...
        if fill_na is None:
            ...
            df = clean_data.drop_columns_until_drop_nan_not_empty(df, n_reg_min=500) # elimina las columnas hasta que pueda hacer dropna() # CAMBIAR NOMBRE DE FUNCION
            print("B", df.shape)
...
class Modeling:
    ...
    def generate_test_design(self, df: pd.DataFrame, bal_type, test_val_size: float = 0.2, test_size: float = 0.5, fill_na = None, export: bool = True):
        """
...
def main():
    ...
    # Hiperparametros
    fill_na = 'ml' # 'ml'  # Relleno de nan values [None, mode, ml]
    ...
    if data_prep:
        ...
        n_days = 60  # Numero de dias anteriores para calcular las estadisticas promedio
        ...
        thr_fs = 0.4  # Peso minimo de una variable para ser considerada como importante [0-1] (siendo 1 el peso de la variable mas importante y 0 la menos)
        ...
        if build_specific_model:
            ...
            d_params = {
                ...
                'LogisticRegression': {
                    ...
                    'C': 5,  # Podria probar un 3.0 en vez de 5  # Inverso de la fuerza de regularización.
                    'solver': 'liblinear', # Algoritmo a utilizar en la optimización del problema.
