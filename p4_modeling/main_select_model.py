...
def main(
        ...
        for idx, row in df_ite_filt.iterrows():
            ...
            new_row = {
                ...
                **d_metric, **roi_values_sin_ea, 'ROI_sin_ea': roi_sin_ea,          # sin ea
                # **exp_roi_values_sin_ea, 
                'exp_roi_sin_ea': exp_roi_sin_ea,
                # **roi_values_con_ea, 
                'ROI_con_ea': roi_con_ea,                      # con ea
    ...
    ## Seleccion de modelo
    l_metrics = ['roi_last_25_matches_sin_ea', 'roi_last_50_matches_sin_ea', 'ROI_sin_ea'] # 'expected_roi_last_25_matches_sin_ea', 'exp_roi_sin_ea'] 
