...
def assess_models_in_prod(
    ...
    for idx, row in df_ite.iterrows():
        ...
        df_pred_met, d_rois = bs.calculate_roi_in_combination(df_pred, d_params) # Ver si hago solo el yield en vez del ROI --> Deberia separar la aplicacion de la strategia del calculo del roi
