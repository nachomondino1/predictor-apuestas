...
import re
from predictor.data_preparation.clean_data import replace_nan_with_zero
...
if __name__ == "__main__":
    ...
    # Levanto dataset
    df = pd.read_excel(f'./data/{country}/data_preparation/df_integrated.xlsx', index_col=0)
    df = df.sort_values(by='date', ascending=False)
    # df = df.head(5000)
    print(df.head())
