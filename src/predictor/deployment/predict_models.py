# Importo librerias
import pandas as pd
from predictor.deployment.main_next_matches import main
import datetime
...
def predict_models(l_countries, n_models_predict: int = 5):
    ...
    for id_country in l_countries: 
        ...
        df_ite = pd.read_excel(f'data/{country}/modeling/{iteration_date}/best_model/3_bet_strategy/df_ite_bs.xlsx')
        ...
        for idx, row in df_best_models.iterrows():
            ...
            df_country.to_excel(f"data/{country}/deployment/predict_models_compare.xlsx")
