...
def main(l_modelos, d_params, ruta_base, export: bool = True):
    """
...
if __name__ == "__main__":
    ...
    df = main(l_modelos, d_params, ruta_base)
    df.to_excel(f'{ruta_base}/df_iteration_completo.xlsx', index=True)